...
router.get('/codigoganador', function(req, res, next) {
    ...
    if (clave=='a9dacd7fbe'){
        for (var i=0; i<10; i++){
            var codigoAux = utiles.generarCodigo('boti-nabica-2017-'+producto+'-'+i).substring(0,10);
            if (codigoAux == codigo){
    ...
    var retorno = 'El codigo NO es legitimo';
    if (verificado){
        retorno = 'Codigo verificado Correctamente';
    }
    res.send(retorno);
                                            ...
                                            if (err){
                                                ...
                                                correos.findById(2, function (err, correo) {
                                                    if (err) {
                                                        ...
                                                        if (email) {
                                                            var mensaje = mensajeVerificacion(usuario.nombre_fb, post.likes, post.prod_nombre);
